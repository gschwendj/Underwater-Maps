#!/usr/bin/env python
"""draws a 2D map of the dive site Känzeli und Hafen Mols
...
annotations[3].update(dict(ax=0, ay=50))
annotations[0]["y"] = annotations[0]["y"] - 5

for annotation in annotations:
    annotation.update(dict(showarrow=True, arrowhead=2, arrowsize=2))
    annotation["y"] = annotation["y"] - 300
...
fig.update_layout(
    title="Tauchplatz Känzeli und Hafen Mols",
    font=dict(size=18),
