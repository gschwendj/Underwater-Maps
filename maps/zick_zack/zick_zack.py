#!/usr/bin/env python
"""draws a 2D map of the dive site Zick Zack
...
from src.divesites import Zick_zack
...
fig = go.Figure(
    data=[
        go.Contour(
            ...
            z=Zick_zack().elevationData[50:200, :],
            showscale=False,
...
fig.update_layout(
    title="Tauchplatz Zick Zack",
    font=dict(size=18),
    annotations=annotations,
)

fig.write_image("{}/zick_zack.pdf".format(current), scale=4, width=1000, height=440)
